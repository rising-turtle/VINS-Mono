...
void predict(const sensor_msgs::ImuConstPtr &imu_msg)
{
    ...
    double dx = imu_msg->linear_acceleration.x*nG;
    double dy = imu_msg->linear_acceleration.y*nG;
    double dz = imu_msg->linear_acceleration.z*nG;
...
void process()
{
    while (true)
    {
        ...
        for (auto &measurement : measurements)
        {
            ...
            // cout <<" receive feature_points: "<<img_msg->points.size()<<" at "<<std::fixed<<img_msg->header.stamp.toSec()<<endl; 
